...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ modkey }, "Print", function()
    awful.spawn.with_shell("flameshot full -p ~/Pictures -c")
  end,
    { description = "Take screenshot, save to ~/Pictures, and copy to clipboard", group = "launcher" }),
...
awful.spawn.with_shell("sh ~/.config/awesome/bg-script.sh")
